        ...
        <div className="fixed inset-0 bg-tanne-950/40 flex items-center justify-center p-4 z-30 no-print">
          <div className="bg-papier rounded-xl shadow-lg w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
            <h2 className="font-display text-lg font-semibold text-tanne-900 mb-1">
              Gutschrift freigeben?
            </h2>
            <p className="text-sm text-tanne-700/70 mb-4">
              Nach der Freigabe wird die Gutschrift-Nummer vergeben und die Gutschrift
              kann nicht mehr geändert werden. Bitte prüfe die Angaben.
            </p>
            ...
            <div className="rounded-lg border border-tanne-900/10 bg-white/70 divide-y divide-tanne-900/5 text-sm mb-4">
              <div className="flex justify-between px-4 py-2">
                ...
                <span className="font-medium text-tanne-900 text-right">
                  {kunden.find((k) => k.id === gutschrift.customer_id)?.name || '— fehlt —'}
                </span>
              </div>
              <div className="flex justify-between px-4 py-2">
                <span className="text-tanne-700/70">Datum</span>
                <span className="text-tanne-900 text-right">
                  {gutschrift.gutschriftdatum
                    ? new Date(gutschrift.gutschriftdatum).toLocaleDateString('de-DE')
                    : '— nicht gesetzt —'}
                </span>
              </div>
              <div className="flex justify-between px-4 py-2">
              ...
              <div className="flex justify-between px-4 py-2">
                <span className="text-tanne-700/70">Gesamtbetrag</span>
                <span className="font-semibold text-tanne-900 text-right">
                  {summen.brutto.toFixed(2)} €
                </span>
              </div>
            </div>
