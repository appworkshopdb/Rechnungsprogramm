        ...
        <div className="fixed inset-0 bg-tanne-950/40 flex items-center justify-center p-4 z-30 no-print">
          <div className="bg-papier rounded-xl shadow-lg w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
            ...
            <p className="text-sm text-tanne-700/70 mb-4">
              Nach der Freigabe wird die Rechnungsnummer vergeben und die Rechnung
              kann nicht mehr geändert werden (gesetzliche Vorgabe). Bitte prüfe die
              Angaben.
            </p>
            ...
            <p className="text-xs text-tanne-700/60 mb-4">
              Stimmt etwas nicht? Schließe diesen Dialog mit „Zurück &amp; bearbeiten",
              korrigiere die Rechnung und gib sie danach frei.
            </p>
